...
public class Habitat {
	...
	public Habitat(World world){
		...
		}while((Collisions.collideObstacle(getArea(), world) || Collisions.collideAnimals(getArea(), world.animalList) || Collisions.collideFood(getArea(), world) || Collisions.collideHabitatsArea(getArea(), world)) && tries <= 100);
		if (tries >= 100) {
