...
public class Food{
    ...
    public void setPos(World world){
        ...
        }while((Collisions.collideObstacle(Body, world) || Collisions.collideAnimals(Body, world.animalList) || Collisions.collideFood(Body, world) || Collisions.collideHabitatsArea(Body, world)) && tries <= 100);
        if (tries >= 100) {
